...
class ApiResultTest {
    ...
    private final ObjectMapper kotlinObjectMapper = new ObjectMapper()
    ...
    @Nested
    @DisplayName("With KotlinModule")
    class KotlinModuleTest {

        @Test
        @DisplayName("ApiResult with MultiValueMap should serialize and deserialize correctly with KotlinModule")
        void shouldSerializeAndDeserializeMultiValueMapWithKotlinModule() throws JsonProcessingException {
            // Given
            final MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
            headers.add("Content-Type", "application/json");
            headers.add("X-Custom-Header", "value1");
            ...
            // When
            final String json = kotlinObjectMapper.writeValueAsString(original);
            final ApiResult deserialized = kotlinObjectMapper.readValue(json, ApiResult.class);
        ...
        @Test
        @DisplayName("ApiResult with null MultiValueMap should serialize and deserialize correctly with KotlinModule")
        void shouldHandleNullMultiValueMapWithKotlinModule() throws JsonProcessingException {
            // Given
            final ApiResult original = ApiResult.builder()
                    .status(HttpStatus.OK)
                    .responseHeaders(null)
        ...
        @Test
        @DisplayName("ApiResult with empty MultiValueMap should serialize and deserialize correctly with KotlinModule")
        void shouldHandleEmptyMultiValueMapWithKotlinModule() throws JsonProcessingException {
            // Given
            final MultiValueMap<String, String> headers = new LinkedMultiValueMap<>();
